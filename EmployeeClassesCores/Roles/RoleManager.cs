...
namespace EmployeeClasses.Roles
{
    internal class RoleManager : NetworkBehaviour
    {
        ...
        public float weightPenalty1H = 1f;
        public float weightPenalty2H = 1f;
        ...
        public void changeRole(Role role)
        {
            ...
            foreach (RoleTag tag in tags.ToArray())
            {
                ...
                else if (tag.Id == (int)RoleTag.Ids.WEIGHT_MULTIPLIER_1H)
                {
                    weightPenalty1H = tag.Power;
                }
                else if (tag.Id == (int)RoleTag.Ids.WEIGHT_MULTIPLIER_2H)
                {
                    weightPenalty2H = tag.Power;
                }
        ...
        public void UpdateIt()
        {
            ...
            if ((ability == null && headlamp == null) || (((!player.isPlayerControlled) || StartOfRound.Instance.inShipPhase) && !NetworkManager.Singleton.IsHost))
            {
